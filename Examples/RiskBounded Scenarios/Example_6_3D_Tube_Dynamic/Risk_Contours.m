...
syms x1 x2 x3 w1 w2 w3 w4 t
Delta=0.01; % Acceptable risk level
%% uncertain moving object g={(x1,x2): g(x1,x2,x3 w1,w2,w3,w4,t)>=0 } with uncertain parameter w1, w2, w3, w4 *****
...
g = (w1)^2-((x1-2-0.1*w2)/1)^2-((x2-2-0.1*w3)/2)^2 -((x3-5+t/1.5-0.1*w4)/2)^2;
