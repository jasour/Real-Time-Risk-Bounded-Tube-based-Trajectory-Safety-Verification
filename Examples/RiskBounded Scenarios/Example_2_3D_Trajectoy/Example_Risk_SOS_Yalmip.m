...
% Obs(x) <=0 ---> Safe(x)>=0 --->Safe(x(t),y(t),z(t))>=0 for all t0 =<t=< tf
status_1=func_3D_SOS_yalmip(Safe_1,Px,Py,Pz,t0,tf,d);
status_2=func_3D_SOS_yalmip(Safe_2,Px,Py,Pz,t0,tf,d);
